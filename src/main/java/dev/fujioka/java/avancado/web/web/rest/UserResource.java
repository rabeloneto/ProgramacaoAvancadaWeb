...
public class UserResource {
    ...
    @GetMapping("/user/firstname/{name}")
    public List<User> getUserByFirstName(@PathVariable String name){
    	return userService.findUserByFistName(name);
    }
    
    @GetMapping("user/asc")
    public List<User> findAllByDtUpdateAsc(){
    	return userService.findAllByDtUpgradeAsc();
    }
    
    @GetMapping("/user/desc")
    public List<User> findAllByDtCreationDesc(){
    	return userService.findAllByDtCreationDesc();
    }
