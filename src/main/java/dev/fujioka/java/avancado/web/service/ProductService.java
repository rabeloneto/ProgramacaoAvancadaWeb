...
public class ProductService
    ...
    public List<Product> findAllByDtUpdateAsc(){
    	return productRepository.findAllByOrderByDtUpdateAsc();
    }
    
    public List<Product> findAllByDtCreationDesc(){
    	return productRepository.findAllByOrderByDtCreationDesc();
    }
    ...
    public List<Product> findByNomeAndDescription(String name, String description){
